...
scene = bpy.data.scenes['Hound_Blockout_v01']
bpy.context.window.scene = scene
model = bpy.data.collections['HOUND_v01_MODEL_ONLY']
...
if not scene.world:
    scene.world = bpy.data.worlds.new('Hound01_StudioWorld')
...
for name, position in views:
    camera_name = 'Hound01_Camera_' + name
    ...
    scene.camera = camera
    scene.render.filepath = 'D:/Projects/Gloom/docs/art/hound/blockout-v01/' + name + '.png'
...
extra_camera = bpy.data.objects.get('Hound01_ReviewCamera')
if extra_camera:
...
bpy.ops.wm.save_as_mainfile(filepath='D:/Projects/Gloom/art/characters/hound/v01/hound-blockout-v01.blend', check_existing=False)
bpy.ops.export_scene.gltf(filepath='D:/Projects/Gloom/assets/characters/hound_blockout/v01/hound-blockout.gltf',
...
bpy.context.view_layer.update()
bpy.ops.export_scene.gltf(filepath='D:/Projects/Gloom/.cache/hound-blockout/source/hound-viewer.gltf',
                         export_format='GLTF_SEPARATE', use_selection=True, use_active_scene=True, export_yup=True, export_apply=True,
